...
impl Request {
    ...
    pub fn as_vec(&self, url: &String) -> Vec<String> {
    ...
    pub fn as_json(&self, from: &String, to: &String, data: &String, url: &String) -> Vec<String> {


        // \"gas\":\"0x76c0\",\"gasPrice\":\"0x76c0\",\"value\":\"0x9184e72a\",
        let params = format!("{{\"jsonrpc\":\"{}\",\"method\":\"{}\", \"params\":[{{\"from\":\"{}\",\"to\":\"{}\",\"data\":\"{}\"}},\"latest\"], \"id\":{}}}", self.jsonrpc, self.method, from, to, data, self.id);
