...
impl Request {
    ...
    pub fn as_json(&self, from_block: &String, contract: &String, topic: &String, url: &String) -> Vec<String> {


        let params = format!("{{\"jsonrpc\":\"{}\",\"method\":\"{}\", \"params\":[{{\"fromBlock\":\"{}\",\"toBlock\":\"latest\",\"address\":\"{}\",\"topics\":[\"{}\"]}}], \"id\":{}}}", self.jsonrpc, self.method, from_block, contract, topic, self.id);
    ...
    pub fn as_clean(&self, from_block: &String, contract: &String, topic: &String, url: &String) -> Vec<String> {


        let params = format!("{{\"jsonrpc\":\"{}\",\"method\":\"{}\", \"params\":[{{\"fromBlock\":\"{}\",\"topics\":[\"{}\"]}}], \"id\":{}}}", self.jsonrpc, self.method, from_block, topic, self.id);
    ...
    pub fn for_check(&self, filter_id: &String, url: &String) -> Vec<String> {
    ...
    pub fn as_subgraph_query(&self, url: &String) -> Vec<String> {

        let params = format!("{{\"jsonrpc\":\"{}\",\"method\":\"{}\", \"params\":{:?}, \"id\":{}}}", self.jsonrpc, self.method, self.params, self.id);
